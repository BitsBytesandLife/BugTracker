...
namespace BugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,TicketId,UserId,FileName,FileData,FileContentType,FormFile")] TicketAttachment ticketAttachment)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["TicketId"] = new SelectList(_context.Ticket, "Id", "Title", ticketAttachment.TicketId);
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "Id", ticketAttachment.UserId);
            return View(ticketAttachment);
        }
